        ...
        <div className='w-[96%]  mx-auto my-28'>
            ...
            <div className='mt-10 '>
                <>
                    ...
                    >
                        {
                            tours.map(tour => <SwiperSlide className='' key={tour.id}>
            ...
            <div className='mt-16 grid grid-cols-1 lg:grid-cols-3 gap-8'>
                ...
                <div className='px-3 py-8 flex gap-3 items-center shadow-2xl hover:transition hover:duration-300 hover:bg-green-600 hover:text-white rounded-lg'>
                    <Image className='h-[60px] w-[60px]' src={rabbit} alt='rabbit'></Image>
                    <div>
                        <p className='font-bold'>Best Security</p>
                        <p className=''>When nothing prevents our to we like best, every pleasure to be.</p>
                    </div>
                </div>
                ...
                <div className='px-3 py-8 flex gap-4 items-center shadow-2xl hover:transition hover:duration-300 hover:bg-green-600 hover:text-white rounded-lg'>
                    <Image className='h-[60px] w-[60px]' src={router} alt='router'></Image>
                    <div>
                ...
                <div className='px-3 py-8 flex gap-4 items-center shadow-2xl hover:transition hover:duration-300 hover:bg-green-600 hover:text-white rounded-lg'>
                    <Image className='h-[60px] w-[60px]' src={solar} alt='solar'></Image>
                    <div>
                ...
                <div className='px-3 py-8 flex gap-4 items-center shadow-2xl hover:transition hover:duration-300 hover:bg-green-600 hover:text-white rounded-lg'>
                    <Image className='h-[60px] w-[60px]' src={fishing} alt='fishing'></Image>
                    <div>
