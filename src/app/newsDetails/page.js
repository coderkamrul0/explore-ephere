...
const page = () => {
    return (
        <div className=''>
            <div className='text-white bg-center bg-no-repeat bg-stone-500 bg-blend-multiply bg-cover lg:h-[450px] h-[300px]' style={{ backgroundImage: "url('https://gaviaspreview.com/wp/gowilds/wp-content/uploads/2023/01/tour-5.jpg')" }}>
