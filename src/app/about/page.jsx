        ...
        <div>
            ...
            <div className=' py-28 px-8'>
                ...
                <div className=' grid grid-cols-1 lg:grid-cols-2 gap-8'>
                    ...
                    <div className={`space-y-3`}>
                        ...
                        <h3 className={`text-5xl  w-[676px] mx-auto font-bold pt-2   leading-snug`}>
                        ...
                        <div className='flex items-center gap-3 pt-8'>
                            ...
                            <div className='flex gap-3'>
                                ...
                                <button className='w-[204px] h-[59px] bg-[#5a9b3e] text-white text-center rounded-lg'>Discover More</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-5'>
                        ...
                        <div className='py-8 px-5 shadow-2xl  h-[310px] rounded-lg'>
                            <div className='w-[80px] h-[80px] bg-slate-300 rounded-full flex justify-center items-center hover:bg-[#5a9b3e]'>
            ...
            <div className='px-8 pt-10 grid grid-cols-1 lg:grid-cols-2 gap-16  '>
                ...
                <div className={`space-y-3 mt-10 `}>
                    ...
                    <h3 className={`text-5xl   mx-auto font-bold pt-2   leading-snug`}>
            ...
            <div className='bg-cover bg-center' style={{ backgroundImage: `url('${team_members_bg}')` }}>
                <div className='py-28 px-8'>
                    <SectionTitle
                        title="Team members"
